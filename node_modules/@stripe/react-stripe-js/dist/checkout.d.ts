...
type LoadActionsSuccess = Extract<stripeJs.StripeCheckoutLoadActionsResult, {
    type: "success";
}>["actions"];
type DistributiveOmit<T, K extends keyof any> = T extends any ? Omit<T, K> : never;
type StripeCheckoutActions = DistributiveOmit<CheckoutSdk, "on" | "loadActions"> & Omit<LoadActionsSuccess, "getSession">;
